# O algoritmo de Round Robin é um algoritmo de escalonamento de processos que atribui a cada processo um quantum de tempo para ser executado. Quando o quantum de um processo acaba, o próximo processo é selecionado e executado pelo mesmo tempo. Isso é repetido até que todos os processos sejam finalizados. Com isso, o algoritmo tenta equilibrar o tempo de execução entre os processos, diminuindo o tempo de espera de processos com burst time maior em comparação a outros algoritmos de escalonamento, como o FCFS (First-Come, First-Served).
